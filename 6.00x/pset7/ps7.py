...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        tup = (math.floor(pos.getX()),math.floor(pos.getY()))
        if not self.isTileCleaned(*tup):
            self.clean_tiles.append(tup)
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    return float(totalTries / num_trials)

#print runSimulation(10, 1.5, 25, 25, 1.0, 50, StandardRobot)
